...
# A light gray-white grid of straight lines covering the whole background,
# like window panes / boxes — "Vision 2".
line_color = (222, 224, 228, 255)
line_width = max(2, int(SIZE * 0.004))
n_cols = 6
n_rows = 6
...
img.save("/home/claude/logo_v2_preview.png")

# Also a smaller favicon-style version
small = img.resize((64, 64), Image.LANCZOS)
small.save("/home/claude/favicon_v2_preview.png")
print("done")
