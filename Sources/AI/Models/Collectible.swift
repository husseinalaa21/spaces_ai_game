...
enum DotStyle: String, Codable, CaseIterable, Identifiable, CosmeticOption {
    ...
    var swatchColor: Color {
        ...
        case .galaxy: return Color(red: 0.32, green: 0.18, blue: 0.55)
        case .silver: return Color(red: 0.75, green: 0.78, blue: 0.82)
        case .ruby: return Color(red: 0.80, green: 0.08, blue: 0.22)
        case .emerald: return Color(red: 0.08, green: 0.65, blue: 0.35)
        case .sapphire: return Color(red: 0.12, green: 0.32, blue: 0.85)
        case .obsidian: return Color(red: 0.08, green: 0.08, blue: 0.10)
        ...
        case .fire: return Color(red: 1.0, green: 0.35, blue: 0.05)
        case .ice: return Color(red: 0.65, green: 0.90, blue: 1.0)
        case .electric: return Color(red: 1.0, green: 0.92, blue: 0.15)
        case .toxic: return Color(red: 0.55, green: 0.92, blue: 0.12)
        case .mint: return Color(red: 0.60, green: 0.92, blue: 0.82)
        case .lava: return Color(red: 0.85, green: 0.15, blue: 0.05)
        case .crystal: return Color(red: 0.85, green: 0.95, blue: 1.0)
        case .shadow: return Color(red: 0.05, green: 0.05, blue: 0.08)
        case .chrome: return Color(red: 0.82, green: 0.85, blue: 0.88)
        case .nebula: return Color(red: 0.50, green: 0.20, blue: 0.70)
        case .candy: return Color(red: 1.0, green: 0.55, blue: 0.80)
        case .royal: return Color(red: 0.38, green: 0.10, blue: 0.58)
        case .frost: return Color(red: 0.80, green: 0.93, blue: 1.0)
        case .sunburst: return Color(red: 1.0, green: 0.65, blue: 0.10)
        case .amethyst: return Color(red: 0.55, green: 0.25, blue: 0.75)
        case .jade: return Color(red: 0.10, green: 0.55, blue: 0.45)
        case .platinum: return Color(red: 0.88, green: 0.90, blue: 0.92)
        case .coral: return Color(red: 1.0, green: 0.50, blue: 0.45)
        case .storm: return Color(red: 0.30, green: 0.35, blue: 0.45)
        case .blossom: return Color(red: 1.0, green: 0.78, blue: 0.86)
        case .ember: return Color(red: 0.90, green: 0.25, blue: 0.08)
        case .glacier: return Color(red: 0.70, green: 0.92, blue: 0.98)
        case .phantom: return Color(red: 0.28, green: 0.22, blue: 0.35)
        case .starlight: return Color(red: 0.95, green: 0.97, blue: 1.0)
        case .wildfire: return Color(red: 0.95, green: 0.20, blue: 0.05)
        case .velvet: return Color(red: 0.35, green: 0.05, blue: 0.20)
        }
    }
